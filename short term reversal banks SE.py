# -*- coding: utf-8 -*-
"""
Created on Wed Nov 24 10:38:35 2021
...
#=============================================================================
# =============================================================================
hist = yf.download('NDA-SE.ST SWED-A.ST SEB-A.ST SHB-A.ST', start='2015-01-01', end=tday_str)
# =============================================================================
#=============================================================================
...
percentile80_shortable = ret_5d.quantile(0.75,axis=1)
...
percentile20 = ret_5d.quantile(0.25,axis=1)
...
transaction_cost = 0.000#29#n_longs*29#0.00058
