# -*- coding: utf-8 -*-
"""
Created on Thu Dec  2 08:50:29 2021
...
#=============================================================================
# =============================================================================
hist = yf.download('SCA-B.ST STE-R.ST HOLM-B.ST BILL.ST', start='2015-01-01', end=tday_str)
# =============================================================================
#=============================================================================
...
print("   ")
print('Short term reversal FOREST')
...
ret_per_year = g.sum()
print("   ")
print("st reversal FOREST with factor momentum returns per year")
print(ret_per_year)
...
print("   ")
print('20-day momentum of short term reversal FOREST strategy')
