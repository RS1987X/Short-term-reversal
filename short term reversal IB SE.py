# -*- coding: utf-8 -*-
"""
Created on Wed Nov 24 10:52:41 2021
...
#FASTAT.ST
re_names = 'BURE.ST CRED-A.ST  FLAT-B.ST INDU-C.ST INVE-B.ST ' \
                   'KINV-B.ST LATO-B.ST LUND-B.ST  SVOL-B.ST VNV.ST ORES.ST'
#=============================================================================
# =============================================================================
...
percentile20 = ret_5d.quantile(0.5,axis=1)
...
long_ind = (ret_5d.le(percentile20,axis=0)) & not_excluded #& (ADT>0)
...
print("   ")
print('Short term reversal INVESTMENT COMPANIES')
...
ret_per_year = g.sum()
print("   ")
print("st reversal INVESTMENT COMPANIES with factor momentum returns per year")
print(ret_per_year)
...
print("   ")
print('20-day momentum of short term reversal INVESTMENT COMPANIES strategy')
